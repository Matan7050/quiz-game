...
while not quiz_finished:
    ...
    #exit_button = tk.Button(question_window_root, text="Exit", font=("Arial", 15, "bold"),command=lambda: exit_application(question_window_root), bg="grey", fg="white", width=20,height=5)
    ...
    #exit_button.grid(row=2, column=0, columnspan=2, pady=5, padx=5)  # span two columns for the Exit button
